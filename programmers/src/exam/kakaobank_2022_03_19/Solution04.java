...
public class Solution04 {
    ...
    public static void main(String[] args) {
        String[] directory1 = {"/", "/hello",  "/hello/tmp", "/root", "/root/abcd", "/root/abcd/exam.etc", "/root/abcd/hello"};
        String[] command1 = {"mkdir /root/tmp", "cp /hello /root/tmp", "rm /hello", "rm /root"};
